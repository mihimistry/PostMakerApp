package com.maxgen.postmakerapp.stickerView;
...
public class StickerTextView extends EditText {
    ...
    public StickerTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDeleteIcon = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.mipmap.icon_delete));
        mZoomIcon = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.mipmap.icon_resize));
        mFlipIcon = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.mipmap.icon_flip));
    }
